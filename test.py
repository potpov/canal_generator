...
def test2D(model, test_loader, splitter, epoch, evaluator, config, writer=None, dumper=None, final_mean=True):
...
def test3D(model, test_loader, epoch, evaluator, config, dumper=None, writer=None, skip_mean=False):
